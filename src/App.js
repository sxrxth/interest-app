...
function App() {
  ...
  const handleCalculate = (e) => {
    ...
    } else setInterest((principle * rate * year) / 100);
  };
  const handleReset = () => {
    setPriciple(0);
    setInterest(0);
  ...
  return (
    ...
    >
      <div style={{ width: "500px" }} className=" bg-light rounded p-5 ">
        ...
        <div
          style={{ height: "150px" }}
          className="shadow d-flex justify-content-center align-items-center flex-column bg-info rounded"
        >
          <h1>₹ {interest}</h1>
        ...
        <form onSubmit={handleCalculate} className="mt-5">
          ...
          {!isValid && <div className="mb-3 text-danger">*Invalid input</div>}
          <div className="mb-3">
            <TextField
              className="w-100"
              id="outlined-basic"
          ...
          <Stack direction="row" spacing={2}>
            <Button
              ...
              variant="contained"
              disabled={isValid && israteValid && isyearValid ? false : true}
            >
              Calculate
            </Button>
            <Button
